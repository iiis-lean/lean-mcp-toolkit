...
| `lsp_assist` | higher-level LSP proof assistance | `lsp.completions`, `lsp.multi_attempt`, `lsp.declaration_soundness`, `lsp.declaration_soundness_batch`, `lsp.compiled_declaration_batch` |
